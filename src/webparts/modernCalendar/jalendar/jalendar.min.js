(function(c){c.fn.jalendar=function(f){function C(){u[1]=E(F);var n=new Date;n.setFullYear(p,h,0);n=n.getDay()+A;a.find(".header h1").html(m[b.lang][h]+" "+p+'<div class="total-bar"></div>');a.find(".day").html("&nbsp;").removeAttr("data-date").removeClass("this-month have-event disable-selecting");for(var d=0;d<42-(n+u[h]);d++)a.find(".day").eq(n+u[h]+d).html("<span>"+(d+1)+"</span>");for(d=0;d<n;d++){var e=void 0==u[h-1]?u[11]:u[h-1];a.find(".day").eq(d).html("<span>"+(e-n+(d+1))+"</span>")}for(d=
    ...
    "");a.find(".added-event").each(function(b){c(this).attr("data-id",b);a.find('.this-month[data-date="'+c(this).attr("data-date")+'"]').addClass("have-event "+c(this).data("type")).append(g("div","event-single").attr("data-id",b).append(g("a","").attr("href",c(this).attr("data-link")).attr("target","_blank").text(c(this).attr("data-title"))))});M();null!==b.dayColor&&a.find(".day span, .day span a").css({color:b.dayColor});null!==b.titleColor&&a.find(".header h1, .header .prv-m, .header .nxt-m, .event-single p, h3, .close-button").css({color:b.titleColor});
    ...
    monthWithZero:!0,sundayStart:!1,dayColor:null,titleColor:null,weekColor:null,todayColor:null,selectingBeforeToday:!1,selectingAfterToday:!1,done:null},f);f={};var m={},e={},k={};f.EN="Mon Tue Wed Thu Fri Sat Sun".split(" ");f.TR="Pzt Sal \u00c7ar Per Cum Cmt Pzr".split(" ");f.ES="Lun Mar Mi\u00e9 Jue Vie S\u00e5b Dom".split(" ");f.DE="Mon Die Mit Don Fre Sam Son".split(" ");f.FR="Lun Mar Mer Jeu Ven Sam Dim".split(" ");f.IT="Lun Mar Mer Gio Ven Sab Dim".split(" ");f.FIL="Lun Mar Miy Huw Biy Sab Lin".split(" ");
    ...
    m.FR="Janvier F\u00e9vrier Mars Avril Mai Juin Juillet Ao\u00fat Septembre Octobre Novembre D\u00e9cembre".split(" ");m.IT="Gennaio Febbraio Marzo Aprile Maggio Guigno Luglio Agosto Settembre Ottobre Novembre Dicembre".split(" ");m.FIL="Enero Pebrero Marso Abril Mayo Hunyo Hulyo Agosto Setyembre Oktubre Nobyembre Disyembre".split(" ");m.RU="\u042f\u043d\u0432\u0430\u0440\u044c \u0424\u0435\u0432\u0440\u0430\u043b\u044c \u041c\u0430\u0440\u0442 \u0410\u043f\u0440\u0435\u043b\u044c \u041c\u0430\u0439 \u0418\u044e\u043d\u044c \u0418\u044e\u043b\u044c \u0410\u0432\u0433\u0443\u0441\u0442 \u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c \u041e\u043a\u0442\u044f\u0431\u0440\u044c \u041d\u043e\u044f\u0431\u0440\u044c \u0414\u0435\u043a\u0430\u0431\u0440\u044c".split(" ");
    ...
    m.PT="Janeiro Fevereiro Mar\u00e7o Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" ");m.PL="styczen luty marzec kwiecien maj czerwiec lipiec sierpien wrzesien pazdziernik listopad grudzien".split(" ");e.EN="Event(s)";e.TR="Etkinlik";e.ES="Evento(s)";e.DE="T\u00e4tigkeit";e.FR="Activit\u00e9(s)";e.IT="Attivit\u00e0";e.FIL="Aktibidad";e.RU="\u0414\u0435\u044f\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c";e.NL="Activiteit(en)";e.ZH="\u4e8b\u4ef6";e.HI="\u092a\u0930\u093f\u0923\u093e\u092e";
    e.PT="Eventos";e.PL="Dzia\u0142alno\u015b\u0107";k.EN="Close";k.TR="Kapat";k.ES="Cerrar";k.DE="Schlie\u00dfen";k.FR="Fermer";k.IT="Chiudere";k.FIL="Isara";k.RU="\u0417\u0430\u043a\u0440\u044b\u0432\u0430\u0442\u044c";k.NL="Sluiten";k.ZH="\u95dc\u9589";k.HI="\u092c\u0902\u0926 \u0915\u0930\u0947";k.PT="Fechar";k.PL="Zamkn\u0105\u0107";var r=new Date,K=r.getDate(),J=r.getMonth(),I=r.getFullYear(),a=c(this),g=function(a,b){return c(document.createElement(a)).addClass(b)};r=""===b.color2?b.color:b.color2;
    ...
    for(e=0;42>e;e++)a.find(".days").append(g("div","day"));var A=0;1==b.sundayStart&&(a.find(".day-names").append(g("h2").text(f[b.lang][6])),A=1);for(e=A;7>e;e++)a.find(".day-names").append(g("h2").text(f[b.lang][e-A]));var y=new Date(b.customDay),p=y.getFullYear(),L=y.getDate(),h=y.getMonth(),F,E=function(a){a=new Date;a.setYear(p);a.setMonth(1);a.setDate(29);return a=29==a.getDate()===!0?29:28},u=[31,E(F),31,30,31,30,31,31,30,31,30,31],l=null,B=null,v=null,z=null,q=null,w=null;C();f=[a.find(".prv-m"),
